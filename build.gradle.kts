...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-lang-json", "2.0.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-lang-json")
        description.set("kotlin-lang-json")
        url.set("https://github.com/wabbit-corp/kotlin-lang-json")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-lang-json")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-lang-json.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-lang-json.git")
        }
    }
}
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.lang.json"
        compileSdk = 34
        minSdk = 26
    }
...
dokka {
    moduleName.set("kotlin-lang-json")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-lang-json/tree/master/src")
